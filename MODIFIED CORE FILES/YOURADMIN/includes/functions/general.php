 ...
 * @version $Id: general.php for CEON URI Mapping 2018-03-29 08:07:33Z webchills $
 */
...
//die('DONE TESTING');
  ...
  // BEGIN CEON URI MAPPING 1 of 2
    global $ceon_uri_mapping_admin;
    
    if (is_null($ceon_uri_mapping_admin)) {
      require_once(DIR_FS_CATALOG . DIR_WS_CLASSES . 'class.CeonURIMappingAdmin.php');
      
      $ceon_uri_mapping_admin = new CeonURIMappingAdmin();
    }
...
//    }
  ...
  // BEGIN CEON URI MAPPING 2 of 2
    global $ceon_uri_mapping_admin, $ceon_uri_mapping_product_pages, $ceon_uri_mapping_product_related_pages;

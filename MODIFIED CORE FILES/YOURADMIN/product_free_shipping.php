 ...
 * @version $Id: product_free_shipping.php for CEON URI Mapping 2018-03-29 08:13:51Z webchills $
 */
  ...
  require(DIR_WS_MODULES . 'category_product_listing.php');
    ...
    switch ($action) {
      ...
      case 'edit_category':
        ...
        $ceon_uri_mapping_admin->addURIMappingFieldsToEditCategoryFieldsArray((int) $cInfo->categories_id);

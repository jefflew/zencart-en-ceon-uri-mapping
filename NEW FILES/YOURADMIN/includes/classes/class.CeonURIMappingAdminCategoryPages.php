 ...
 * @version     $Id: class.CeonURIMappingAdminCategoryPages.php 2018-04-06 09:45:15Z webchills $
 */
...
class CeonURIMappingAdminCategoryPages extends CeonURIMappingAdminCategories
{
	 ...
	 * @return  none
	 */
	public function insertUpdateHandler($category_id, $current_category_id)
	{
	 ...
	 */
	public function buildCategoryURIMappingFields($prev_uri_mappings)
	{
		global $languages;

 ...
 * @version     $Id: class.CeonURIMappingTabbedPanelAdminInterface.php 2018-04-06 12:45:15Z webchills $
 */
...
class CeonURIMappingTabbedPanelAdminInterface extends CeonURIMappingAdmin
{
	 ...
	 * @access  protected
	 */
	public $_ceon_base_model_code = null;
	 ...
	 * @access  protected
	 */
	public $_ceon_model_edition_code = null;
	 ...
	 * @access  protected
	 */
	public $_copyright_start_year = null;
	 ...
	 * @access  protected
	 */
	public $_web_address_uri_part = null;
	 ...
	 * @access  protected
	 */
	public $_automatic_version_checking = null;
	 ...
	 */
	public function _lookUpInstalledVersion() {}
	 ...
	 * @return  none
	 */
	public function _addPanel($id, $title, $link, $content = null)
	{
		$this->_panels[] = array(
			'id' => $id,
			'title' => $title,
...
TABBED_PANELS_MENU_JS;
	 ...
	 */
	public function _buildConfigSettingDescRow($id, $label, $description)
	{
		$table_row = '		<tr>
	 ...
	 */
	public function _buildConfigPanel($id, $title, $table_rows, $content = null)
	{
	 ...
	 */
	public function _buildSubPanel($title, $content)
	{
		$panel = '				<fieldset>
					<legend>';
	 ...
	 * @return  none
	 */
	public function _buildSubmitAndCancelButtons()
	{
	...
	public function _buildFooter()
	{
		...
		$footer .= '<p id="version-info">' . TEXT_FILES_VERSION . ': ' . $this->_version .
			(null !== $this->_edition_title ? ' ' . $this->_edition_title : '') . "\n";
		
		$footer .= '<br />' . TEXT_INSTALLED_VERSION . ': ' .
			(null === $this->_installed_version ? TEXT_NOT_INSTALLED : $this->_installed_version .
			(null !== $this->_edition_title ? ' ' . $this->_edition_title : ''));
...
//		$footer .= $this->_getVersionCheckerOutput();
	 ...
	 *                    the version.
	 */
	public function _getVersionCheckerOutput()
	{
		$output = '';
		...
		if (extension_loaded('curl') && (null === $this->_automatic_version_checking ||
			...
			if (isset($_SESSION[$this->_ceon_base_model_code . '_vc_response'])) {
				...
				if (null !== $this->_ceon_model_edition_code) {
			...
			if (strlen($version_checker_response) == 0) {
				...
				if (null !== $this->_installed_version) {
				...
				$output .= '<p style="margin-top: 0.4em">' . TEXT_LATEST_VERSION_IS . ' <strong>' .
					...
					(null !== $this->_edition_title ? ' ' . $this->_edition_title : '') . '</strong></p>';

 ...
 * @version     $Id: class.CeonURIMappingHandlerBase.php 2018-04-06 11:31:10Z webchills $
 */
...
class CeonURIMappingHandlerBase extends CeonURIMappingDBLookup
{
	 ...
	 * @access  protected
	 */
	public $_request_uri_value_identified = null;
	 ...
	 * @access  protected
	 */
	public $_language_changed = false;
	 ...
	 * @access  protected
	 */
	public $_original_language_id = null;
	...
	function __construct()
	{
		...
		// now
		if (null === $this->_request_uri_value_identified) {
	 ...
	 */
	public function _normaliseServerEnvironment()
	{
		global $PHP_SELF;
	 ...
	 */
	public function _checkRequestURI()
	{
	 ...
	 * @return  none
	 */
	public function _initLanguageSystem()
	{
		...
		if (null === $this->_original_language_id) {
			$this->_original_language_id = $_SESSION['languages_id'];
		}
	}
	 ...
	 */
	public function _checkForAndHandleIndexPage()
	{
	 ...
	 * @return  none
	 */
	public function _handleStaticURI() {}
	 ...
	 * @return  none
	 */
	public function _handleZCDynamicURI() {}
	 ...
	 * @return  none
	 */
	public function _handleHistoricalURIWithNoCurrentMapping($main_page, $associated_db_id, $query_string_parameters) {}
	 ...
	 * @return  none
	 */
	public function _handleUnmappedURI($main_page, $associated_db_id, $query_string_parameters) {}
	 ...
	 */
	public function _getCurrentURI($main_page, $associated_db_id, $query_string_parameters, $language_id)
	{
		global $db;
		...
		} else if (null !== $query_string_parameters) {
			$selections = array(
				'main_page' => zen_db_prepare_input($main_page),
	 ...
	 */
	public function _buildArrayQueryParameter($key, $value)
	{
		$parameter_string = '';

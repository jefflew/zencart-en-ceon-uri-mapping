 ...
 * @version     $Id: class.CeonURIMappingHREFLinkBuilder.php 2018-03-29 08:45:15Z webchills $
 */
	...
	public function buildHREFLink($base_link, $main_page, $parameters, $connection, $add_session_id)
	{
		...
		if ($link != '') {
            ...
            if ($add_session_id == true && $session_started == true && SESSION_FORCE_COOKIE_USE == 'False') {
				...
				$sid = constant('SID');  
				} else if ((($request_type == 'NONSSL' && $connection == 'SSL' && ENABLE_SSL == 'true') ||
                        ($request_type == 'SSL' && $connection == 'NONSSL')) && $http_domain != $https_domain) {
